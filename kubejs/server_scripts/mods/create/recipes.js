ServerEvents.recipes(e => {
  ...
  let { crushing, deploying, pressing, mixing, compacting, mechanical_crafting } =
    e.recipes.create;
  ...
  compacting("armageddon_mod:emerald_totem", [
    "4x minecraft:emerald",
    "armageddon_mod:gilded_plate",
  ]);

  pressing("kubejs:dark_metal_sheet", ["born_in_chaos_v1:dark_metal_ingot"]);
  ...
  mechanical_crafting("celestisynth:keres", ["ABCD", "EFGH", "IJKG", "LKJF"], {
  ...
  deploying("forbidden_arcanus:soul ", [
    "minecraft:soul_sand",
  ...
  mechanical_crafting("kubejs:fartinium_ingot", ["ABBC", "DEFD", "DEFD", "GHHI"], {
  ...
  mechanical_crafting("create:creative_motor", ["ABAB", "ABAB", "ABAB", "ABAC"], {
    A: "create_new_age:advanced_motor_extension",
    B: "create_new_age:reinforced_motor",
    C: "kubejs:linggangoonium_ingot",
  });

  mechanical_crafting("create:handheld_worldshaper", ["AAAA", "BBBB", "CCCC", "DDDE"], {
